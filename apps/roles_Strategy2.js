...
export const rule = {
    roles_Strategy2: {
        ...
        describe: "【#角色攻略2】获取第二份已有角色攻略概览" //【命令】功能说明
    }
};
...
export function roles_Strategy2 (e) {
    ...
    let path = `${_path}/plugins/yiyi-plugin/resources/roles_Strategy2/${name}.png`;
    console.log (path);
